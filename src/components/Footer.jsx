  ...
  return (
    <footer className="footer p-10 bg-base-200 text-base-content">
        ...
        <div>
            ...
            <button onClick={()=> scrollToSection(services.current)} className="link link-hover">Landing/Presentation web pages</button> 
            <button onClick={()=> scrollToSection(services.current)} className="link link-hover">Web Apps</button> 
            <button onClick={()=> scrollToSection(services.current)} className="link link-hover">Server hosting and maintenance</button> 
        </div> 
        <div>
